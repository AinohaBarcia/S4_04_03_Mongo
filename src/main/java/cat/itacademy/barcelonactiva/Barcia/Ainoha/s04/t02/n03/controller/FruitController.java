package cat.itacademy.barcelonactiva.Barcia.Ainoha.s04.t02.n03.controller;
...
import cat.itacademy.barcelonactiva.Barcia.Ainoha.s04.t02.n03.model.service.FruitService;
...
public class FruitController {
    ...
    public ResponseEntity<Fruit> updateFruitById(@PathVariable String id, @RequestBody Fruit newFruitData) {
        try {
    ...
    public ResponseEntity<HttpStatus> deleteFruitById (@PathVariable String id){
